...
import icon from "~/assets/bga2myludo_icon.png";
                            ...
                            <Card>
                                <CardContent>
                                    ...
                                    <Typography variant="body2" className="onboarding-paragraph">
                                        Migration du plugin vers le framework WXT (auparavant Plasmo). Aucun changement visible pour vous, mais une base technique plus moderne pour les prochaines fonctionnalités !
                                    </Typography>
                                </CardContent>
                            </Card>
                        </Grid>
